...
@WebServlet("/reporteAfiliadoMes")
public class ServletReportAfiliadosMes extends HttpServlet {
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			try(Connection con=ds.getConnection();
				...
				byte[] byteStream=generador.generarReporte(null, "/reporte/top_afiliados.jrxml", "test", salida);
