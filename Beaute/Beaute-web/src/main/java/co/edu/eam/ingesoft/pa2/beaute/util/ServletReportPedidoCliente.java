...
@WebServlet("/pedidosClientes")
public class ServletReportPedidoCliente extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try(Connection con=ds.getConnection();
			...
			byte[] byteStream=generador.generarReporte(null, "/reportes/catalogoPedidoCliente.jrxml", "test", salida);
